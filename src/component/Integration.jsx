...
const Intergrations = () => {
    ...
    return(
        <>
            <section>
                <div className="main">
                    <div className="integration-work" style={{marginBottom:'8%'}}>
                        <div className="featurse-main" style={{textAlign:'center'}}>
                        <button style={{backgroundColor:'#ececf7',padding:'8px 14px',fontSize:'14px',fontWeight:'500',border:'1px solid white',borderRadius:'18px'}}>INTEGRATIONS</button>
                            <h1 style={{textAlign:'center',fontSize:'44px',marginBottom:'1%',marginTop:'1%',color:"black",fontWeight:'700',lineHeight:'55px'}}>Packed with all the key integrations <br></br>you need</h1>
